...
{
    class Identific//класс идентификаторов
    {
        //static public HashSet<string> Ident = new HashSet<string>();
        static public Dictionary<byte, string> Ident = new Dictionary<byte, string>();
    }
    class Keywords//класс ключевых слов
    {
        public Dictionary<byte, Dictionary<string, byte>> kw = new Dictionary<byte, Dictionary<string, byte>>();
        ...
        public Keywords()
        {
            ...
            tmp["real"] = LexicalAnalyzer.realsy;//добавила
            tmp["char"] = LexicalAnalyzer.charsy;//добавила
            kw[4] = tmp;
            tmp = new Dictionary<string, byte>();
            ...
            tmp["integer"] = LexicalAnalyzer.integersy;//добавила
            tmp["boolean"] = LexicalAnalyzer.booleansy;//добавила
            kw[7] = tmp;
            tmp = new Dictionary<string, byte>();
    ...
    class Erro//класс для ошибок
    {
        static public Dictionary<int, string> errorre = new Dictionary<int, string>()
        {
